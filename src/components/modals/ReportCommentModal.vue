...
import { reportComment } from '@/api/comments.service'
import { ref } from 'vue'
...
async function submitReport() {
  try {
    ...
    await reportComment(props.commentId, reason.value)
...
<template>
  <div class="overlay" @click.self="emit('close')">
    <div class="modal">
      ...
      <p class="description">Explain why you are reporting this comment.</p>
